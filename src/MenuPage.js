...
const MenuPage = () => {
  return (
    <div>
      <h1 className='menu-title'>Discover Happiness in Every Bite at Theo's Bakery</h1>
      <ul className="menu-container">
        ...
        <li>
          ...
          <img src="https://preview.colorlib.com/theme/bakery2/img/story/story-2.jpg" alt="Cookies" />
          <h4>Pancakes</h4>   
